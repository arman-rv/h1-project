const Footer = () => {
    return (
      <>
          <div className="border border-red-600/0 relative h-[300px] bg-backFooter bg-bottom bg-contain bg-no-repeat">
            <div className="container w-[90%] mx-auto mt-[110px]">
              <div className="flex flex-row justify-center gap-4">
                <div className="basis-1/2">
                <h4>درباره آموزشگاه</h4>
                  <p style={{color:'var(--text-col4)'}} className="w-[80%] text-[14px] text-justify">
                ...
                <div className="basis-1/5">
                  <h4>آدرس آموزشگاه</h4>
                  <p style={{color:'var(--text-col4)'}} className="w-[80%] text-[14px]">ساری ، بلوارخزر، ششصد دستگاه، آموزشگاه بحر</p>
                </div>
                <div className="basis-1/5">
                  <h4>تماس با ما </h4>
                  <p style={{color:'var(--text-col4)'}} className="w-[80%] text-[14px]">011-33883358</p>
                  <p style={{color:'var(--text-col4)'}} className="w-[80%] text-[14px]">دوشنبه – جمعه : 8:00 – 18:00</p>
                </div>
                <div className="basis-1/5">
            ...
            <div  style={{color:'var(--text-col4)'}} className="w-full text-[14px] text-center absolute bottom-2">کلیه حقوق این وب سایت برای آکادمی بحر محفوظ است.©</div>
          </div>
      </>
    );
  };
