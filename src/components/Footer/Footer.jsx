...
const Footer = () => {
  return (
    <footer
      style={{
        color: "var(--text-col4)",
        background: "var(--statistics-back)",
      }}
      className="shadow-cardShadow"
    >
      <div className="p-10 pt-20 text-base-content">
        <div
          style={{ color: "var(--text-col4)" }}
          className="flex flex-wrap justify-center md:justify-around gap-12 w-[90%] mx-auto"
        >
          <div className="flex flex-col sm:flex-row md:flex-col gap-2 sm:gap-8 md:gap-2">
            <h4 className="mb-4">خدمات</h4>
            <span className="flex flex-col gap-2">
              <Link>آموزش حرفه ای</Link>
              <Link>مشاوره رایگان</Link>
              <Link>فرصت های شغلی</Link>
            </span>
          </div>
          <div className="flex flex-col sm:flex-row md:flex-col gap-2 sm:gap-8 md:gap-2">
            <h4 className="mb-4">آموزشگاه</h4>
            <span className="flex flex-col gap-2">
            <Link>درباره ما</Link>
            <Link>ارتباط با ما</Link>
            <Link>قوانین آموزشگاه</Link>
            </span>
          </div>
          <form className="flex flex-col sm:flex-row md:flex-col gap-2 sm:gap-8 md:gap-2">
            <h4 className="mb-4">اخبار آموزشگاه</h4>
            <fieldset className="form-control w-80">
              <label className="label">
                <span>
                  برای دریافت اخبار به روز آموزشگاه ایمیل خود را وارد کنید{" "}
                </span>
              </label>
              <div className="relative">
                ...
                <div
                  ...
                  className="btn absolute top-0 left-0 border border-transparent rounded-r-none"
                >
                  ثبت
                </div>
              </div>
      ...
      <div className="footer items-center">
        <div className="flex flex-col-reverse md:flex-row items-center md:justify-between w-[90%] border-t border-gray-400 p-4 mx-auto">
          <aside className="flex gap-2 items-center grid-flow-col">
